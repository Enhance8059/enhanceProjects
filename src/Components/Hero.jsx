    ...
    <Box paddingBottom={'50px'}>
            <Flex w={'80%'} m={'auto'} mt={['30px','30px','90px','90px']} justifyContent={'space-between'} direction={['column','column','column','row']}>
              ...
              <Text mb={'15px'} fontSize={['22px','22px','38px','38px']} lineHeight={'44px'} fontFamily={'PlayfairDisplay-Regular'} color={'#3D2B1F'}> About Us</Text>
                <Text fontSize={['15px','15px','20px','20px']}>Enhance Projects is a market leader in integrated infrastructures and construction, continually offering effective solutions to construction challenges. Our dedication goes from project initiation to full operation, providing dependability at all times.   </Text>
              <Text fontWeight={'400'} fontFamily={'"Poppins", sans-serif'} fontSize={['15px','15px','20px','20px']} lineHeight={'26px'} mt={'10px'}>We offer the twin benefit of local presence and vast geographical reach through strategically positioned offices. A team of highly qualified individuals from several industries oversees each project. <br/> Maurya Homes, the forerunner of the new generation of real estate, pays close attention to every detail in order to provide exceptional service to our consumers. </Text>
              </Box>
